import { ContractTransaction, BytesLike as Arrayish, BigNumber, BigNumberish, BaseContract } from 'ethers';
...
export declare type NameRegistryEvents = 'AdminChanged' | 'Approval' | 'ApprovalForAll' | 'BeaconUpgraded' | 'CancelRecovery' | 'ChangeFee' | 'ChangePool' | 'ChangeRecoveryAddress' | 'ChangeTrustedCaller' | 'ChangeVault' | 'DisableTrustedOnly' | 'Initialized' | 'Invite' | 'Paused' | 'Renew' | 'RequestRecovery' | 'RoleAdminChanged' | 'RoleGranted' | 'RoleRevoked' | 'Transfer' | 'Unpaused' | 'Upgraded';
...
export declare type NameRegistryMethodNames = 'DEFAULT_ADMIN_ROLE' | 'approve' | 'balanceOf' | 'bid' | 'cancelRecovery' | 'changeFee' | 'changePool' | 'changeRecoveryAddress' | 'changeTrustedCaller' | 'changeVault' | 'completeRecovery' | 'disableTrustedOnly' | 'expiryOf' | 'fee' | 'generateCommit' | 'getApproved' | 'getRoleAdmin' | 'grantRole' | 'hasRole' | 'initialize' | 'isApprovedForAll' | 'isTrustedForwarder' | 'makeCommit' | 'name' | 'ownerOf' | 'pause' | 'paused' | 'pool' | 'proxiableUUID' | 'reclaim' | 'recoveryClockOf' | 'recoveryDestinationOf' | 'recoveryOf' | 'register' | 'renew' | 'renounceRole' | 'requestRecovery' | 'revokeRole' | 'safeTransferFrom' | 'safeTransferFrom' | 'setApprovalForAll' | 'supportsInterface' | 'symbol' | 'timestampOf' | 'tokenURI' | 'transferFrom' | 'trustedCaller' | 'trustedOnly' | 'trustedRegister' | 'unpause' | 'upgradeTo' | 'upgradeToAndCall' | 'vault' | 'withdraw';
...
export interface NameRegistry extends BaseContract {
     ...
     */
    bid(to: string, tokenId: BigNumberish, recovery: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param tokenId Type: uint256, Indexed: false
     */
    cancelRecovery(tokenId: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    changeFee(_fee: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    changePool(_pool: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param recovery Type: address, Indexed: false
     */
    changeRecoveryAddress(tokenId: BigNumberish, recovery: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    changeTrustedCaller(_trustedCaller: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    changeVault(_vault: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param tokenId Type: uint256, Indexed: false
     */
    completeRecovery(tokenId: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     * Type: function
     */
    disableTrustedOnly(overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    expiryOf(parameter0: BigNumberish, overrides?: ContractCallOverrides): Promise<BigNumber>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param recovery Type: address, Indexed: false
     */
    generateCommit(fname: Arrayish, to: string, secret: Arrayish, recovery: string, overrides?: ContractCallOverrides): Promise<string>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param _pool Type: address, Indexed: false
     */
    initialize(_tokenName: string, _tokenSymbol: string, _vault: string, _pool: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    isTrustedForwarder(forwarder: string, overrides?: ContractCallOverrides): Promise<boolean>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    makeCommit(commit: Arrayish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param tokenId Type: uint256, Indexed: false
     */
    reclaim(tokenId: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param parameter0 Type: uint256, Indexed: false
     */
    recoveryClockOf(parameter0: BigNumberish, overrides?: ContractCallOverrides): Promise<BigNumber>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param parameter0 Type: uint256, Indexed: false
     */
    recoveryDestinationOf(parameter0: BigNumberish, overrides?: ContractCallOverrides): Promise<string>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param parameter0 Type: uint256, Indexed: false
     */
    recoveryOf(parameter0: BigNumberish, overrides?: ContractCallOverrides): Promise<string>;
    /**
     * Payable: true
     * Constant: false
     * StateMutability: payable
     ...
     * @param recovery Type: address, Indexed: false
     */
    register(fname: Arrayish, to: string, secret: Arrayish, recovery: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: true
     * Constant: false
     * StateMutability: payable
     ...
     * @param tokenId Type: uint256, Indexed: false
     */
    renew(tokenId: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param to Type: address, Indexed: false
     */
    requestRecovery(tokenId: BigNumberish, to: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    safeTransferFrom(from: string, to: string, tokenId: BigNumberish, data: Arrayish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    timestampOf(parameter0: Arrayish, overrides?: ContractCallOverrides): Promise<BigNumber>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: pure
     ...
     */
    trustedRegister(fname: Arrayish, to: string, recovery: string, inviter: BigNumberish, invitee: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     */
    upgradeTo(newImplementation: string, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: true
     * Constant: false
     * StateMutability: payable
     ...
     * @param data Type: bytes, Indexed: false
     */
    upgradeToAndCall(newImplementation: string, data: Arrayish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    withdraw(amount: BigNumberish, overrides?: ContractTransactionOverrides): Promise<ContractTransaction>;
}
