...
export const nameRegistryAbi = [
    ...
    {
        inputs: [
            { internalType: 'bytes16', name: 'fname', type: 'bytes16' },
            { internalType: 'address', name: 'to', type: 'address' },
            { internalType: 'bytes32', name: 'secret', type: 'bytes32' },
            { internalType: 'address', name: 'recovery', type: 'address' },
        ],
        name: 'generateCommit',
        outputs: [{ internalType: 'bytes32', name: 'commit', type: 'bytes32' }],
